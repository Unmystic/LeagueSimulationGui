...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(2, _translate("Dialog", "Balanced"))
        self.comboBox.setItemText(0, _translate("Dialog", "Very Defensive"))
        self.comboBox.setItemText(1, _translate("Dialog", "Defensive"))
